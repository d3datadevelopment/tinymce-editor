...
<base href='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/")}]'>
<title>Roxy File Manager</title>
<link href='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/css/jquery-ui-1.10.4.custom.min.css")}]' rel="stylesheet" type="text/css" />
<link href='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/css/main.min.css")}]' rel="stylesheet" type="text/css" />
<script type="text/javascript" src='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/js/jquery-1.11.1.min.js")}]'></script>
<script type="text/javascript" src='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/js/jquery-ui-1.10.4.custom.min.js")}]'></script>
<script type="text/javascript" src='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/js/custom.js")}]'></script>
<script type="text/javascript" src='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/js/main.min.js")}]'></script>
<script type="text/javascript" src='[{$oViewConf->getModuleUrl("o3-tinymce-editor","out/fileman/js/jquery-dateFormat.min.js")}]'></script>
</head>
<body>
<style>
    #pnlDirList .selected,
...
<table cellpadding="0" cellspacing="0" id="wraper">
  ...
  <tr>
    <td class="bottomLine">
      &nbsp;&nbsp;&nbsp;&copy; <span id="copyYear"></span> RoxyFileman, <a href="https://www.d3data.de" target="_blank">D3 Data Dev.</a>
    </td>
    <td class="bottomLine">
